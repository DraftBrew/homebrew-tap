class Aider < Formula
  ...
  url "https://github.com/paul-gauthier/aider/archive/refs/tags/v0.44.0.tar.gz"
  ...
  resource "litellm" do
    url "https://files.pythonhosted.org/packages/3a/f2/29d302ef5279c795e2548ed9be4dcd3f9f9f87aa56ad6ce3d5a5cbdff9d6/litellm-1.41.6.tar.gz"
    sha256 "ac0c4bc51b64ce38d6290d6e9b5683c19a6bcb76b4ca64381e286256c013d39a"
  end
  ...
  resource "openai" do
    url "https://files.pythonhosted.org/packages/88/57/706aaa40cda2dc79e1ff02aaaf7c66332da31c027707afd23e26bee8af05/openai-1.35.10.tar.gz"
  ...
  test do
    assert_match "aider #{version.to_s}", shell_output("#{bin}/aider --version")
  end
end
